...
def start_camera():
    global camera_active, cap, send_video_to_laravel, video_thread, stop_event
...
def generate_frames():
    ...
    while camera_active:
        try:
            # Non-blocking check untuk camera status
...
def video_feed():
    ...
    return Response(generate_with_error_handling(),
